sand.define('drawing/Canvas',['drawing/Buttons'], function (req) {
    ...
    return Seed.extend({
      ...
      '+init' : function(obj) {
         ...
         this.paths = [];
          ...
          this.canvas.onmousedown = function(e) { 
             ...
             var o = {type : this.curTool, size : this.curSize, color : this.curColor, points : [[e.clientX - this.canvas.offsetLeft + document.body.scrollLeft, e.clientY - this.canvas.offsetTop + document.body.scrollTop]]};
     ...
     this.canvas.onmousemove = function(e) {
         if(draw.clicking){
            this.paths.last().points.push([e.clientX - this.canvas.offsetLeft + document.body.scrollLeft ,e.clientY - this.canvas.offsetTop + document.body.scrollTop])
